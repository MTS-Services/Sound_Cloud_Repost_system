    ...
    @if ($showRepostActionModal && $campaign)
        <div class="w-full max-w-md mx-auto rounded-2xl shadow-2xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden"
            ...
            <div
                ...
                <button x-on:click="$wire.closeConfirmModal()" type="button" :disabled="isSubmitting"
            ...
            <div class="px-6 py-4 space-y-5">
                ...
                <div class="flex justify-center gap-4">
                    <button wire:click="repost" @click="isSubmitting = true" wire:loading.attr="disabled"
                        :disabled="isSubmitting"
                        class="w-full flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
