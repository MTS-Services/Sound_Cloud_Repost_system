                    ...
                    <div class="lg:col-span-3 space-y-4 sm:space-y-6">
                        <div x-data="{ activeTab: @entangle('activeTab').live }">
                            ...
                            <div
                                ...
                                <a href="{{ route('user.my-account.user', $user->name) }}?tab=insights" wire:navigate
                                ...
                                <a href="{{ route('user.my-account.user', $user->name) }}?tab=tracks" wire:navigate
                                ...
                                <a href="{{ route('user.my-account.user', $user->name) }}?tab=playlists" wire:navigate
                                ...
                                <a href="{{ route('user.my-account.user', $user->name) }}?tab=reposts" wire:navigate
                                ...
                                @if (user()->urn == $user->urn)
                                    <a href="{{ route('user.my-account.user', $user->name) }}?tab=transaction"
                                        wire:navigate
