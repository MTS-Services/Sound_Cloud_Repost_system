                                        ...
                                        <div
                                            ...
                                            <div class="col-span-1 flex items-center justify-center space-x-1">
                                                @if (isset($source['actionable']))
                                                    <button
                                                        class="w-8 h-8 rounded-full flex items-center justify-center transition duration-200 {{ $source['like'] ? 'bg-red-500 text-white shadow-lg' : 'bg-gray-700 text-gray-300' }}  cursor-default!">
                                                        <x-lucide-heart class="w-3 h-3" />
                                                    </button>
                                                    <button
                                                        class="w-8 h-8 rounded-full flex items-center justify-center transition duration-200 {{ $source['repost'] ? 'bg-green-500 text-white shadow-lg' : 'bg-gray-700 text-gray-300' }}  cursor-default!">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center justify-center space-x-2">
                                            @if (isset($source['source']))
                                                <button
                                                    class="w-8 h-8 rounded-full flex items-center justify-center {{ $source['like'] ? 'bg-red-500 text-white shadow-lg' : 'bg-gray-700 text-gray-300' }}  cursor-default!">
                                                    <x-lucide-heart class="w-3 h-3" />
                                                </button>
                                                <button
                                                    class="w-8 h-8 rounded-full flex items-center justify-center {{ $source['repost'] ? 'bg-green-500 text-white shadow-lg' : 'bg-gray-700 text-gray-300' }}  cursor-default!">
                                                    <x-lucide-rotate-ccw class="w-3 h-3" />
                                                </button>
                                            @endif
                                        </div>
                            ...
                            @forelse ($topSources as $source)
                                <div
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        @if (isset($source['source']))
                                            <button
                                                class="flex items-center justify-center w-10 h-10 rounded-full transition-all duration-200 bg-gray-700 text-gray-300  border border-gray-600 cursor-default! {{ $source['like'] ? 'bg-red-500 text-white shadow-lg' : '' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <button
                                                class="flex items-center justify-center w-10 h-10 rounded-full transition-all duration-200 cursor-default! {{ $source['repost'] ? 'bg-green-500 text-white shadow-lg' : 'bg-gray-700 text-gray-300' }}  border border-gray-600"><svg
                                        ...
                                        @else
                                            <button
                                                class="flex items-center justify-center w-10 h-10 rounded-full transition-all duration-200 bg-gray-700 text-gray-300  border border-gray-600 cursor-default!">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="lucide lucide-heart w-4 h-4">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    @if (isset($source['source']))
                                                        <button
                                                            class="flex items-center justify-center w-10 h-10 rounded-full transition-all duration-200 bg-gray-700 text-gray-300 {{ $source['like'] ? 'bg-red-500 text-white shadow-lg' : '' }}  border border-gray-300 dark:border-gray-600 cursor-default!"
                                                            title="Like">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                        ...
                                                        <button
                                                            class="flex items-center justify-center w-10 h-10 rounded-full transition-all duration-200 {{ $source['repost'] ? 'bg-green-500 text-white shadow-lg' : 'bg-gray-700 text-gray-300' }}  border border-gray-300 dark:border-gray-600 cursor-default!"
                                                            title="Repost">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                    ...
                                                    @else
                                                        <button
                                                            class="flex items-center justify-center w-10 h-10 rounded-full transition-all duration-200 bg-gray-700 text-gray-300  border border-gray-300 dark:border-gray-600 cursor-default!"
                                                            title="Like">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
