            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div x-data="{ activeTab: @entangle('activeTab').live, playing: @entangle('playing').live }">
                    ...
                    <div x-show="activeTab === 'compactView'"
                        ...
                        {{-- Mobile: card mode with vertical spacing; Desktop/Tablet: grid table --}}
                        <div class="space-y-3 md:space-y-0 overflow-x-auto w-full">

                            {{-- Desktop/Tablet Table --}}
                            <div
                                class="hidden md:block min-w-[768px] bg-gray-200 dark:bg-gray-800 rounded-2xl border border-gray-300 dark:border-gray-700 overflow-hidden">
                            ...
                            <div class="md:hidden flex flex-col space-y-3">
                                @forelse($topSources as $source)
                                    <div
                                        class="bg-gray-200 dark:bg-gray-800 p-4 rounded-2xl border border-gray-300 dark:border-gray-700 flex flex-col gap-2">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <p class="text-sm text-gray-600 dark:text-gray-400 truncate">
                                                        {{ $source['source_details']?->user?->name ?? 'Unknown' }}</p>
                                                </div>
                                            </div>
