                        ...
                        @if (isset($data['detailed']) && !empty($data['detailed']))
                            @php
                                $anyAchievement =
                                    ...
                                    $this->getChangeIcon(
                                        $data['detailed']['overall_metrics']['total_followers']['change_value'],
                                    ) === 'trending-up' ||
                                    $this->getChangeIcon(
                                        $data['detailed']['overall_metrics']['total_reposts']['change_value'],
                                    ) === 'trending-up';
                            @endphp
                            @if ($anyAchievement)
                                @if ($this->getChangeIcon($data['detailed']['overall_metrics']['total_views']['change_value']) === 'trending-up')
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-gray-600 dark:text-gray-400">Total views increased by
                                            {{ number_format($data['detailed']['overall_metrics']['total_views']['change_rate'], 1) }}%</span>
                                    </div>
                                @endif
                                @if ($this->getChangeIcon($data['detailed']['overall_metrics']['total_plays']['change_value']) === 'trending-up')
                                    <div class="flex items-center">
                                        <div class="w-2 h-2 bg-[#ff6b35] rounded-full mr-3"></div>
                                        <span
                                            class="text-sm text-gray-600 dark:text-gray-400">{{ number_format($data['detailed']['overall_metrics']['total_plays']['change_rate'], 1) }}%
                                ...
                                @if ($this->getChangeIcon($data['detailed']['overall_metrics']['total_likes']['change_value']) === 'trending-up')
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-gray-600 dark:text-gray-400">Great engagement with
                                            {{ number_format($data['detailed']['overall_metrics']['total_likes']['change_rate'], 1) }}%
                                            more likes</span>
                                    </div>
                                @endif
                                ...
                                @if ($this->getChangeIcon($data['detailed']['overall_metrics']['total_comments']['change_value']) === 'trending-up')
                                    <div class="flex items-center">
                                        <div class="w-2 h-2 bg-[#ff6b35] rounded-full mr-3"></div>
                                        <span
                                            class="text-sm text-gray-600 dark:text-gray-400">{{ number_format($data['detailed']['overall_metrics']['total_comments']['change_rate'], 1) }}%
                                            growth in comments</span>
                                    </div>
                                @endif

                                @if ($this->getChangeIcon($data['detailed']['overall_metrics']['total_followers']['change_value']) === 'trending-up')
                                    <div class="flex items-center">
                                        <div class="w-2 h-2 bg-[#ff6b35] rounded-full mr-3"></div>
                                        <span class="text-sm text-gray-600 dark:text-gray-400">
                                            Growth of
                                            {{ number_format($data['detailed']['overall_metrics']['total_followers']['change_rate'], 1) }}%
                                            followers</span>
                                    </div>
                                @endif

                                @if ($this->getChangeIcon($data['detailed']['overall_metrics']['total_reposts']['change_value']) === 'trending-up')
                                    <div class="flex items-center">
                                        <div class="w-2 h-2 bg-[#ff6b35] rounded-full mr-3"></div>
                                        <span class="text-sm text-gray-600 dark:text-gray-400">Reposts increased by
                                            {{ number_format($data['detailed']['overall_metrics']['total_reposts']['change_rate'], 1) }}%</span>
                                    </div>
                                @endif
                            @else
                                <div class="flex items-center">
