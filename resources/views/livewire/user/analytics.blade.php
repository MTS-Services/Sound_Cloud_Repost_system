                ...
                <div class="space-y-2">
                    <label class="flex items-center">
                        <input type="checkbox" name="genre"
                            ...
                            value="Electronic">
                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 capitalize">Electronic</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="genre"
                            class="checkbox border-orange-600 bg-transparent checked:border-orange-500 checked:bg-transparent checked:text-orange-600 rounded-full w-5 h-5"
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" name="genre"
                            class="checkbox border-orange-600 bg-transparent checked:border-orange-500 checked:bg-transparent checked:text-orange-600 rounded-full w-5 h-5"
                            value="Pop">
                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 capitalize">Pop</span></label><label
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        <div
                            ...
                            </div><span class="text-sm font-bold text-gray-900 dark:text-white">35.0%</span>
                        </div>
                        <div
                            class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                            <div class="flex items-center">
                                <div class="w-3 h-3 rounded-full mr-3 border border-gray-200 dark:border-gray-600"
                                    ...
                                    Hop</span>
                            </div><span class="text-sm font-bold text-gray-900 dark:text-white">28.0%</span>
                        </div>
                        <div
                            class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                            <div class="flex items-center">
                            ...
                            </div><span class="text-sm font-bold text-gray-900 dark:text-white">20.0%</span>
                        </div>
                        <div
                            class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                            <div class="flex items-center">
                            ...
                            </div><span class="text-sm font-bold text-gray-900 dark:text-white">12.0%</span>
                        </div>
                        <div
                            class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                            <div class="flex items-center">
                ...
                <thead class="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                    <tr>
                        <th
                            ...
                            <div class="flex items-center">Track Name<svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <th
                            class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                            <div class="flex items-center">Stream Growth<svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-chevron-up h-4 w-4 opacity-30">
                                    <path d="m18 15-6-6-6 6"></path>
                        ...
                        <th
                            class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                            <div class="flex items-center">Engagement<svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="w-2 h-8 rounded-full mr-3 bg-gradient-to-b from-[#ff6b35] to-[#ff8c42]">
                                </div>
                                <div>
