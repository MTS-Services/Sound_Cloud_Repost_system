<div>
    ...
    <div class="px-2 py-4 lg:px-4 lg:py-8">
        ...
        <div x-data="{
            ...
            <!-- Search and Filters -->
            <div class="mb-4 lg:mb-8 flex flex-col lg:flex-row gap-4">
                <!-- Filter Buttons -->
                <div class="flex items-center justify-between sm:justify-start gap-4">
                    <div class="relative">
                        <button @click="openByGenre = !openByGenre"
                            class="w-full bg-orange-100 !hover:bg-orange-400 text-orange-600 px-4 py-2 rounded-md flex items-center gap-2 text-sm font-medium transition-colors cursor-pointer">
                            {{ __('Filter by genre') }}
