<div x-data="{ activeMainTab: @entangle('activeMainTab').live, showDashboard: true }">
    ...
    <div x-show="showDashboard" class="w-full p-4">
        <x-dashboard-summary :earnings="user()->repost_price" :dailyRepostCurrent="$data['dailyRepostCurrent']" :dailyRepostMax="proUser() ? 100 : 20" :responseRate="30" :pendingRequests="$data['pendingRequests']"
            :requestLimit="25" :credits="userCredits()" :campaigns="$data['totalMyCampaign']" :campaignLimit="proUser() ? 10 : 2" />
    </div>
    ...
    <section class="flex flex-col lg:flex-row gap-4 lg:gap-6">
        ...
        <div class="w-full pt-52 lg:pt-0">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-5 space-y-3 sm:space-y-0">
                ...
                <button type="button"
                    class="font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 rounded-lg inline-flex items-center justify-center cursor-pointer disabled:cursor-not-allowed bg-orange-600 text-white hover:bg-orange-500 active:bg-orange-700 disabled:bg-orange-500 disabled:text-gray-50 disabled:cursor-not-allowed px-4 py-2 text-base w-full sm:w-auto"
                    wire:navigate="" href="https://repostchain.com/user/members">
                    <span><svg class="w-5 h-5 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
            ...
            <div
                ...
                <div class="flex-1 flex flex-col space-y-2">
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <span class="text-xs text-orange-600 font-semibold">100% <span
                                class="text-gray-900 dark:text-white">Response rate.</span></span>
                        <a href="https://repostchain.com/user/reposts-request" wire:navigate=""
                    ...
                    <div x-data="{ on: false }" class="inline-flex items-center cursor-not-allowed"
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="w-7 h-4 rounded-full relative transition-colors bg-gray-300"
                                :class="on ? 'bg-green-500' : 'bg-gray-300'">
                                <div class="absolute top-0 left-0 w-4 h-4 bg-white rounded-full shadow transition-transform duration-300 translate-x-0"
