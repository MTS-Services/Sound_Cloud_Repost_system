                ...
                <div
                    ...
                    <div class="w-full max-w-2xl mx-auto mt-6 flex flex-col overflow-hidden">
                        ...
                        <div class="h-full overflow-y-auto px-4 pb-6 space-y-1">
                            ...
                            <div wire:click="openRepostsModal({{ $track_->id }})"
                                ...
                                <div class="flex-shrink-0">
                                    <img class="h-12 w-12 rounded object-cover shadow"
                                        src="{{ soundcloud_image($track_->artwork_url) }}" alt="{{ $track_->title }}" />
                                </div>
                            ...
                            @if (count($tracks) < count($allTracks)) <div class="text-center mt-6">
                        ...
                        @if (count($playlists) < count($allPlaylists)) <div class="text-center mt-6">
                ...
                <div class="p-6">
                    ...
                    <div
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 truncate">
                                by
                                <strong class="text-orange-600 dark:text-orange-400">{{ $track->author_username
                                    }}</strong>
                                <span class="ml-2 text-xs text-gray-400">{{ $track->genre }}</span>
                            </p>
                            <span
                                class="inline-block bg-gray-100 dark:bg-slate-600 text-xs px-3 py-1 rounded-full text-gray-700 dark:text-gray-300 mt-2 font-mono">{{
                                $track->isrc }}</span>
                        </div>
                        <div class="flex-shrink-0">
                            <i data-lucide="chevron-right"
                        ...
                        <div class="grid grid-cols-1 gap-3 text-right">
                            ...
                            <div class="flex items-center gap-2 justify-end">
                                ...
                                <span class="text-green-500 dark:text-green-400 font-bold">{{
                                    $user->userInfo?->like_count ?? 0 }}</span>
                            </div>
                        </div>
