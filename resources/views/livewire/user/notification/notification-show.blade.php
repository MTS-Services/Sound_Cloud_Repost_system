        ...
        <div class="card bg-white/90  dark:bg-gray-800/90 shadow-xl">
            <div class="card-body p-8">
                ...
                <div class="prose max-w-none dark:prose-invert">
                    <div class="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-lg p-6 mb-6">
                    ...
                    @if(isset($customNotification->message_data['additional_data']))
                        <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-6 mb-6">
                            <h3 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Additional Information</h3>
                            <div class="space-y-2">
                        ...
                        <div>
                            ...
                            <div class="space-y-1 text-gray-600 dark:text-gray-400">
                                @if($isRead)
                                    ...
                                    @endphp
                                    <div class="text-green-600">✓ Read on {{ $status ? $status->read_at_formatted : 'Unknown' }}</div>
                                @else
