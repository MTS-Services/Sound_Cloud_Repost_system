<div>
    ...
    <main class="">
        <div
            class="flex flex-col mb-6 sticky -top-6 py-4 left-0 z-10 bg-orange-200/10 backdrop-blur-2xl dark:bg-slate-800 rounded-md w-full">
            {{-- Filter and Search Bar --}}
            <div
                class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 z-10 max-w-4xl mx-auto w-full">
                <livewire:user.notification.notification-filter :filter="$filter" :total-count="$totalCount" :unread-count="$unreadCount"
                    :read-count="$readCount" class="w-full sm:w-auto" />
                        ...
                        <div class="flex flex-wrap justify-end gap-2">
                            @if ($unreadCount > 0)
                                <button wire:click="$dispatch('mark-all-as-read')"
                                    ...
                                    class="btn btn-sm flex-1 sm:flex-none py-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white border-none">
                            ...
                            <button wire:click="$dispatch('clear-all-notifications')"
                                ...
                                class="btn btn-sm flex-1 sm:flex-none py-3 btn-outline border-red-300 text-red-600 hover:bg-red-500 hover:text-white hover:border-red-500">
