<div wire:poll.1s="updatePlayingTimes">
    ...
    <div>
        <nav class="-mb-px flex space-x-8">
            ...
            <button
                ...
                {{ __('Recommended Pro') }}
                <span class="text-xs lg:text-[10px] xl:text-xs ml-2 text-orange-500">{{ $totalRecommendedPro }}</span>
            </button>
            ...
            <button
                ...
                class="tab-button py-3 pb-1 px-2 text-md lg:text-sm xl:text-base font-semibold transition-all duration-200 border-b-2">
                {{ __('Recommended') }}
                <span class="text-xs lg:text-[10px] xl:text-xs ml-2 text-orange-500">{{ $totalRecommended }}</span>
            </button>
    ...
    <x-dashboard-summary 
        :earnings="user()->repost_price" 
        :dailyRepostCurrent="2" 
        :dailyRepostMax="20" 
        :responseRate="30"
        :pendingRequests="10" 
        :requestLimit="25" 
