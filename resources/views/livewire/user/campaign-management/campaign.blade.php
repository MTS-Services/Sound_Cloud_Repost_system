<div wire:poll.1s="updatePlayingTimes">
   ...
   <div x-data="{ openFilterByTrack: false, openFilterByGenre: false }"
    ...
    <!-- Filters wrapper (Track + Genre side by side on mobile, inline on desktop) -->
    ...
    x-transition:leave-start="transform opacity-100 scale-100"
    x-transition:leave-end="transform opacity-0 scale-95"
    class="absolute left-0 mt-2 w-full sm:w-96 max-h-72 overflow-y-auto rounded-md shadow-lg z-100">
    ...
    <!-- Search box (goes below filters on mobile, inline on desktop) -->
    <div x-data="{ showInput: false }"
        class="w-full sm:w-64 relative flex items-center text-gray-600 dark:text-gray-400 border border-gray-300 dark:border-gray-600 rounded mt-2 sm:mt-0">
