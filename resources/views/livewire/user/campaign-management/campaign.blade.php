    ...
    <div x-data ="{ openFilterByTrack: false, openFilterByGenre: false }"
        ...
        <div class="relative">
            <button @click="openFilterByGenre = !openFilterByGenre, openFilterByTrack = false"
                class="{{ count($selectedGenres) > 0 ? ' bg-orange-100 ' : ' bg-white ' }} hover:bg-orange-300 text-orange-600 px-4 py-2 rounded-md flex items-center gap-2 text-sm font-medium transition-colors">
