                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-between gap-4">
                                        ...
                                        <div class="relative">
                                            <!-- Repost Button -->
                                            <button
                                                @if (!session()->has('repostedId') && session()->get('repostedId') == null) wire:click="confirmRepost('{{ $campaign_->id }}')" @endif
                                                @class([
                                                    ...
                                                    'bg-gray-300 dark:bg-gray-600 text-gray-500 dark:text-gray-400 cursor-not-allowed' => !$this->canRepost(
                                                        $campaign_->id),
                                                    '!bg-green-600 !text-white cursor-not-allowed' => session()->has('repostedId') && session()->get('repostedId') != null,
