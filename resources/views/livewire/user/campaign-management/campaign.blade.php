                                    ...
                                    <div class="flex items-center gap-3 w-full">
                                        ...
                                        <div x-data="{ open: false }" class="inline-block text-left">
                                            ...
                                            <button wire:click="starMarkUser({{ $campaign_?->music?->user?->urn }})">
                                                <x-lucide-star wire:loading.remove wire:target="starMarkUser"
                                                ...
                                                <x-lucide-star wire:loading wire:target="starMarkUser"
                                                    class="w-5 h-5 mt-1 relative animate-spin {{ $campaign_->user?->starredUsers?->contains('follower_urn', user()->urn)
                                                        ? 'text-orange-300 '
                                                        : 'text-gray-400 dark:text-gray-500' }}"
                                                    fill="{{ $campaign_->user?->starredUsers?->contains('follower_urn', user()->urn) ? 'orange ' : 'none' }}" />
                                            </button>
