                                    ...
                                    <div class="flex items-center gap-3 w-full">
                                        ...
                                        <div x-data="{ open: false }" class="inline-block text-left">
                                            <div @click="open = !open" class="flex items-center gap-1 cursor-pointer">
                                                <span class="text-slate-700 dark:text-gray-300 font-medium">Profile
                                                    Name</span>
                                            ...
                                            <button
                                                ...
                                                @endphp
                                                <x-lucide-star
                                                    class="w-5 h-5 mt-1 relative {{ $starred ? 'text-orange-300 dark:text-orange-400 fill-orange-400' : 'text-gray-400 dark:text-gray-500 fill-transparent' }}" />
                                            </button>
                                    ...
                                    <div class="flex items-center justify-between gap-4 w-full">
                                        <div
                                            ...
                                            <div class="flex items-center gap-1.5">
                                                ...
                                                <span class="text-sm sm:text-base">100</span>
                                            </div>
                                            <span
                                        ...
                                        <div class="relative">
                                            <!-- Repost Button -->
                                            <button
                                                class="flex items-center gap-2 py-2 px-4 sm:px-5 sm:pl-8 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 rounded-lg shadow-sm text-sm sm:text-base transition-colors bg-orange-600 dark:bg-orange-500 hover:bg-orange-700 dark:hover:bg-orange-400 ">
                                                <svg width="26" height="18" viewBox="0 0 26 18"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect x="1" y="1" width="24" height="16" rx="3"
                                                        fill="none" stroke="currentColor" stroke-width="2" />
