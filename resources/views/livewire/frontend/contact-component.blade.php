        ...
        <div class="grid lg:grid-cols-3 gap-8 mb-12">
            ...
            <div class="lg:col-span-2">
                <div class="rounded-2xl bg-zinc-900/50 border border-zinc-800/50 p-8 backdrop-blur-sm">
                    ...
                    <button wire:click="testSubmit" class="text-white">TEST</button>

                    <!-- Contact Form -->
                    <form wire:submit.prevent="contactSubmit" class="contact-form space-y-6">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="name" wire:model.defer="name"
                                    class="w-full px-4 py-3 rounded-xl bg-black/50 border border-zinc-800 text-white placeholder-zinc-500 focus:outline-none focus:border-orange-500 transition-colors @error('name') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <input type="email" id="email" wire:model.defer="email"
                                    class="w-full px-4 py-3 rounded-xl bg-black/50 border border-zinc-800 text-white placeholder-zinc-500 focus:outline-none focus:border-orange-500 transition-colors @error('email') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <select id="subject" wire:model.defer="subject"
                                class="w-full px-4 py-3 rounded-xl bg-black/50 border border-zinc-800 text-white focus:outline-none focus:border-orange-500 transition-colors @error('subject') border-red-500 @enderror"
                                required>
                        ...
                        <div>
                            ...
                            <textarea id="message" wire:model.defer="message" rows="6"
                                class="w-full px-4 py-3 rounded-xl bg-black/50 border border-zinc-800 text-white placeholder-zinc-500 focus:outline-none focus:border-orange-500 transition-colors resize-none @error('message') border-red-500 @enderror"
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            class="w-full px-8 py-4 rounded-xl bg-gradient-to-r from-orange-500 to-orange-400 text-white font-semibold hover:shadow-lg hover:shadow-orange-500/20 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed">
                            ...
                            <!-- Loading Spinner -->
                            <svg wire:loading class="w-5 h-5 animate-spin text-white" fill="none"
                                viewBox="0 0 24 24">
                        ...
                        <div x-data="{ show: false }"
                            x-on:alert.window="if($event.detail.type === 'success'){ show = true; setTimeout(() => show = false, 4000); }"
                            x-show="show" x-transition
                            class="p-4 rounded-xl bg-green-500/10 border border-green-500 text-green-300 text-sm mt-4">
