<x-frontend::layout>
    ...
    <section class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[radial-gradient(ellipse_at_top,rgba(255,85,0,0.08)_0%,#121212_60%)] relative overflow-hidden bg-fixed">
        ...
        <div class="relative w-full max-w-xl group">
            <div class="bg-[#1B1B1B] border border-orange-500/20 rounded-2xl shadow-2xl backdrop-blur-xl p-8 sm:p-14 relative z-10 overflow-hidden transition-all duration-500 ease-in-out group-hover:shadow-3xl group-hover:scale-[1.01] group-hover:border-orange-500/40">
                ...
                <div class="relative z-10 text-white">
                    ...
                    <div class="flex justify-center mb-8 transition-transform duration-300 group-hover:scale-105">
                        <div class="relative">
                            <div class="w-16 h-16 bg-gradient-to-br from-orange-600 to-orange-400 rounded-xl flex items-center justify-center shadow-[0_0_20px_rgba(255,85,0,0.4),_0_0_40px_rgba(255,85,0,0.15)]">
                    ...
                    <div class="text-center mb-8">
                        <h1 class="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent">Admin Panel</h1>
                        <p class="text-base sm:text-lg text-gray-400 mt-2">Secure login for administrators</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.login') }}" class="space-y-6">
                        ...
                        <!-- Email -->
                        <div class="group">
                            <label for="email" class="block text-sm font-medium text-gray-300 group-focus-within:text-orange-400 transition-colors duration-200">Email Address</label>
                        ...
                        <!-- Password -->
                        <div class="group">
                            <label for="password" class="block text-sm font-medium text-gray-300 group-focus-within:text-orange-400 transition-colors duration-200">Password</label>
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                            ...
                            <a href="{{ route('admin.password.request') }}"
                                class="text-sm text-orange-500 hover:text-orange-400 font-medium transition-colors duration-200">Forgot password?</a>
                        </div>
