 <header class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-transparent backdrop-blur-sm">
     <div class="container mx-auto px-4 py-4 flex justify-between items-center">
         <div class="flex gap-2 items-center">
             <div class="w-20">
                <img src="{{env('APP_LOGO') }}" alt="{{ config('app.name') }}" class="w-full h-full dark:hidden">
                <img src="{{env('APP_LOGO_DARK') }}" alt="{{ config('app.name') }}" class="w-full h-full block dark:hidden">
             </div>
         </div>
