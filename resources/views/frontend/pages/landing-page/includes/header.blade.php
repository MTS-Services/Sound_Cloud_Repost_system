 <header class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-transparent backdrop-blur-sm">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center space-x-8">
                ...
                <button class="border-2 border-primary text-primary hover:bg-primary/10 px-3 py-1.5 rounded-md text-sm transition-all">Log In</button>
                <button class="bg-primary hover:bg-primary-hover text-white px-3 py-1.5 rounded-md text-sm transition-all shadow-md hover:shadow-lg">Sign Up</button>
            </nav>
        ...
        <div class="mobile-menu bg-dark-card border-t border-dark-border md:hidden" id="mobile-menu">
            <div class="container mx-auto px-4 py-4 space-y-4">
                ...
                <div class="flex space-x-4 pt-4">
                    <button class="border-2 border-primary text-primary hover:bg-primary/10 px-3 py-1.5 rounded-md text-sm transition-all">Log In</button>
                    <button class="bg-primary hover:bg-primary-hover text-white px-3 py-1.5 rounded-md text-sm transition-all">Sign Up</button>
                </div>
            </div>
        </div>
    </header>
