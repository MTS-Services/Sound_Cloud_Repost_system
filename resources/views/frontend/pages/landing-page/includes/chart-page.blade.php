    ...
    <section>
        <div class="py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div
                    class="bg-gradient-to-r from-gray-900 to-black text-white p-8 rounded-2xl mb-8 border border-gray-800">
                    <div class="max-w-4xl mx-auto">
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div
                                class="bg-gray-800 bg-opacity-50 backdrop-blur-sm p-4 rounded-xl border border-gray-700">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex items-center gap-1 bg-gray-800 rounded-xl p-1 border border-gray-700"><button
                            ...
                            title="Compact View"><svg xmlns="http://www.w3.org/2000/svg" width="24"
