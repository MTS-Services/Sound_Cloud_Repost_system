            ...
            <div class="container mx-auto px-4 pt-16 pb-8">
                <div class="text-center mb-12">
                    <div class="flex items-center justify-center mb-6">
                        <div class="bg-orange-500 p-3 rounded-xl shadow-lg"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                        ...
                        <div class="p-8">
                            <div class="text-center mb-8">
                                ...
                                <p class="text-slate-300 mb-6">Perfect for getting started with music promotion</p>
                                <div class="mb-6">
                            ...
                            <div class="space-y-4 mb-8">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Direct Requests</span><span
                                                class="text-sm font-bold text-orange-400">20</span></div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Campaign Targeting</span></div>
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                ...
                                                Analytics</span><span
                                                class="text-sm font-bold text-orange-400">Basic</span></div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-slate-400">Growth Analytics</span>
                                        </div>
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Collaboration Hub</span></div>
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Support Level</span><span
                                                class="text-sm font-bold text-orange-400">Community Support</span>
                                        </div>
                                    </div>
                                </div>
                            </div><button
                    ...
                    <div
                        ...
                        <div class="p-8">
                            <div class="text-center mb-8">
                                ...
                                <p class="text-slate-300 mb-6">Advanced features for serious music promotion</p>
                                <div class="mb-6">
                                    <div class="flex items-baseline justify-center"><span
                            ...
                            <div class="space-y-4 mb-8">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Direct Requests</span><span
                                                class="text-sm font-bold text-orange-400">100</span></div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Simultaneous
                                                Campaigns</span><span
                                                class="text-sm font-bold text-orange-400">10</span></div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Multi-Account
                                                Promotion</span><span
                                                class="text-sm font-bold text-orange-400">Unlimited</span></div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <div
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Campaign Rating &amp;
                                                Analytics</span><span
                                                class="text-sm font-bold text-orange-400">Advanced
                                                Dashboard</span></div>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Growth Analytics</span></div>
                                        <p class="text-xs text-slate-400 mt-1">reach, followers, reposts</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-2"><span
                                                class="text-sm font-medium text-white">Support Level</span><span
                                                class="text-sm font-bold text-orange-400">Priority Support</span></div>
                                    </div>
                                </div>
                            </div><button
                ...
                <div class="max-w-6xl mx-auto mb-16">
                    <div class="text-center mb-12">
                        <h2 class="text-4xl font-bold text-white mb-4">Join <span
                                class="text-orange-400">10,000+</span>
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slate-300 text-sm">Get 100 direct requests vs 20 on free plan.
                                            Reach
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slate-300 text-sm">Promote unlimited accounts simultaneously.
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slate-300 text-sm">Track reach, followers, and reposts with
                                            detailed
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slate-300 text-sm">Get faster responses and dedicated support to
                ...
                <div class="max-w-6xl mx-auto mb-16">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        <div class="bg-slate-700 rounded-2xl p-6 border border-slate-600">
                            ...
                            <p class="text-slate-300 text-sm">"RepostChain Pro helped me get my track featured on 15
                                major
                        ...
                        <div class="bg-slate-700 rounded-2xl p-6 border border-slate-600">
                            ...
                            <p class="text-slate-300 text-sm">"The analytics dashboard is incredible. I can see exactly
                        ...
                        <div class="bg-slate-700 rounded-2xl p-6 border border-slate-600">
                            ...
                            <p class="text-slate-300 text-sm">"Managing 10 campaigns at once with Pro saved me hours.
                                The
                ...
                <div class="text-center">
                    <div class="bg-slate-700 rounded-2xl p-8 border border-slate-600 max-w-2xl mx-auto">
                        ...
                        <p class="text-slate-300 mb-6">Join thousands of artists who've already transformed their reach
