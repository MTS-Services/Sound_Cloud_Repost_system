                ...
                <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    <div class="lg:w-1/2 flex justify-center">
                        <div class="relative bg-dark-lighter rounded-xl p-6 shadow-xl max-w-md w-full">
                            <div class="absolute -top-3 -left-3 bg-primary rounded-full w-12 h-12 flex items-center justify-center">
                            ...
                            <div class="bg-dark-darker p-4 rounded-lg mb-4 hover:bg-dark-border transition-colors cursor-pointer">
                                <div class="flex items-center gap-3 mb-2">
                                    <div class="w-10 h-10 rounded-full bg-gray-700 overflow-hidden flex-shrink-0">
                                        <img src="https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=40&h=40&fit=crop&crop=face" alt="Artist avatar" class="w-full h-full object-cover">
                                    </div>
                                    <div class="overflow-hidden">
                                        <h4 class="font-medium truncate">Night Vibes</h4>
                                        <p class="text-sm text-gray-400 truncate">electronic_producer</p>
                                    </div>
                                    <button class="bg-primary hover:bg-primary-hover text-white px-3 py-1.5 rounded-md text-sm transition-all ml-auto">
                            ...
                            <div class="bg-dark-darker p-4 rounded-lg hover:bg-dark-border transition-colors cursor-pointer">
                                <div class="flex items-center gap-3 mb-2">
                                    <div class="w-10 h-10 rounded-full bg-gray-700 overflow-hidden flex-shrink-0">
                                        <img src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=40&h=40&fit=crop&crop=face" alt="Artist avatar" class="w-full h-full object-cover">
                                    </div>
                                    <div class="overflow-hidden">
