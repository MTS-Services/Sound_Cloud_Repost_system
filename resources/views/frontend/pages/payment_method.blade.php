                     ...
                     @if ($paypalStatus == 1)
                         <div onclick="selectPayment('paypal')"
                             ...
                             <div class="flex items-center justify-between">
                                 <div class="flex items-center space-x-6">
                                     ...
                                     <div class="flex items-center space-x-4">
                                         ...
                                         <div>
                                             <h3 class="text-2xl font-semibold text-gray-900 dark:text-white mb-1">
                                                 PayPal
                                             </h3>
                                             <p class="text-gray-600 dark:text-white">Pay securely with your PayPal
                                                 account
                                                 or
                                                 credit card.</p>
                                         </div>
                             ...
                             <div class="flex flex-wrap gap-3 mt-6 text-sm text-gray-700">
                                 <div
                                     class="bg-gray-100 dark:text-white px-4 py-2 rounded-lg flex items-center space-x-2">
