     ...
     <div class="flex items-center space-x-6"> 
      ...
      <div class="flex items-center space-x-4"> 
       <div class="bg-blue-600 p-4 rounded-xl transform transition-transform group-hover:scale-110"> 
        <svg class="w-8 h-8 text-white dark:text-white" viewBox="0 0 24 24" fill="currentColor"> 
       ...
       <div> 
        <h3 class="text-2xl font-semibold text-gray-900 dark:text-white mb-1">PayPal</h3> 
        <p class="text-gray-600 dark:text-white">Pay securely with your PayPal account or credit card.</p> 
       </div> 
      </div> 
     </div> 
     <div class="hidden md:flex items-center space-x-2"> 
      <span class="bg-green-100 dark:text-white text-green-800 px-3 py-1 rounded-full text-sm">Secure</span> 
      <span class="bg-blue-100 dark:text-white text-blue-800 px-3 py-1 rounded-full text-sm">Global</span> 
     </div> 
    </div> 
    ...
    <div class="flex items-center justify-between"> 
     <div class="flex items-center space-x-6"> 
      ...
      <div class="flex items-center space-x-4"> 
       ...
       <div> 
        <h3 class="text-2xl font-semibold text-gray-900 dark:text-white mb-1">Stripe</h3> 
        <p class="text-gray-600 dark:text-white">Supports all major credit cards & digital wallets.</p> 
       </div> 
      </div> 
     </div> 
     <div class="hidden md:flex items-center space-x-2"> 
      <span class="bg-purple-100 dark:text-white text-purple-800 px-3 py-1 rounded-full text-sm">Advanced</span> 
      <span class="bg-indigo-100 dark:text-white text-indigo-800 px-3 py-1 rounded-full text-sm">Fast</span> 
     </div> 
    </div> 
    <div class="flex flex-wrap gap-3 mt-6 text-sm text-gray-700"> 
     <div class="bg-gray-100 dark:text-white px-4 py-2 rounded-lg flex items-center space-x-2"> 
