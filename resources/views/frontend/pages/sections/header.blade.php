<nav class="bg-white dark:bg-dark-secondary shadow-sm sticky top-0 z-50 transition-colors duration-300">
                ...
                <div class="hidden md:hidden bg-white dark:bg-dark-secondary shadow-md transition-colors duration-300"
                    ...
                    <div class="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <a href="#"
                            class="block px-3 py-2 text-gray-secondary dark:text-gray-primary hover:bg-primary-50 dark:hover:bg-dark-tartiary hover:text-primary-tartiary rounded-md">Login</a>
                        <a href="#"
                            class="block px-3 py-2 bg-primary-tartiary text-white rounded-md font-medium hover:bg-primary-700 transition-colors duration-200 text-center mt-2">Sign
                            Up Free</a>
                    </div>
                </div>
            </nav>