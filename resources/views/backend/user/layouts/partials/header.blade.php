    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative">
                ...
                <span
                    class="absolute -top-1 -right-1 bg-[#EF4444] text-white text-xs rounded-full w-4 h-4 flex items-center justify-center">1</span>
            </div>
                ...
                <ul tabindex="0"
                    ...
                    <li>
                        <div class="flex items-center space-x-2 border-b border-gray-100 px-6 py-4 w-full">
                            <img src="" alt="name" class="w-8 h-8 rounded-full">
                            <div class="text-sm">
                                <span class="font-semibold text-black">{{ user()->name ?? 'Name' }}</span>
                                <div class="text-green-500 text-xs">● Online</div>
                            </div>
