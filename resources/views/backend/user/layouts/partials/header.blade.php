        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="dropdown dropdown-end">
                <div tabindex="0" role="button" class="flex items-center space-x-2 avatar">
                    ...
                    <div class="text-sm">
                        <span class="font-semibold text-text-light-secondary dark:text-text-dark-secondary">{{ auth()->user()->name }}</span>
                ...
                <ul tabindex="0"
                    ...
                    <li>
                        <div class="flex items-center space-x-2 border-b border-bg-light-muted dark:border-bg-dark-muted px-6 py-4 w-full">
                            <img src="{{ auth()->user()->avatar }}" alt="{{ auth()->user()->name }}"
