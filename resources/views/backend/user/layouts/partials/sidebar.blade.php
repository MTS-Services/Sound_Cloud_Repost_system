<div class="w-74 bg-white dark:bg-slate-800 border-r border-gray-100 dark:border-slate-700 flex flex-col h-[88vh]">
    <!-- Profile Section -->
    <div class="p-3 border-b border-gray-100 dark:border-slate-700 mb-2">
        <div class="flex items-center space-x-3 mb-4">
            <img src="./RepostChain Web App_files/pexels-photo-2379004.jpeg"
                alt="Bhathiya Udara" class="w-14 h-14 rounded-full">
            <div>
        ...
        <a href="{{ route('user.add-credits') }}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                stroke-linejoin="round" class="lucide lucide-plus w-5 h-5">
