<div class="w-74 bg-white dark:bg-slate-800 border-r border-gray-100 dark:border-slate-700 flex flex-col h-[90vh]">
    <!-- Profile Section -->
    <div class="p-3 border-b border-gray-100 dark:border-slate-700 mb-2">
        <div class="flex items-center space-x-3 mb-4">
            <img src="./RepostChain Web App_files/pexels-photo-2379004.jpeg" alt="Bhathiya Udara"
        ...
        <a href="{{ route('user.add-credits') }}"
            ...
            <span class="text-sm">Add Credits</span>
        </a>
    </div>

    <!-- Nav Section (scrolls if too long) -->
    <nav class="flex-1 min-h-0 overflow-y-auto px-3 mt-2">
        <ul class="space-y-1">
            <li>
                <a href="{{ route('user.dashboard') }}"
                    class="sidebar-item transition-colors flex items-center px-3 py-2.5 rounded-lg cursor-pointer font-medium
                   @if ($page_slug == 'dashboard') active @endif
                   hover:text-orange-600 hover:bg-slate-100 dark:hover:text-orange-600 dark:text-slate-300 dark:hover:bg-slate-700"
                    data-page="dashboard">
        ...
        <div class="space-y-1">
            ...
            <a href="{{ route('user.analytics') }}"
                class="flex items-center space-x-3 px-3 py-2 text-base font-medium rounded-lg transition-colors text-slate-500 dark:text-slate-300 hover:text-orange-600 hover:bg-slate-100 dark:hover:text-orange-600  dark:hover:bg-slate-700">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-bar-chart3 w-5 h-5">
            ...
            <a href="#"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    stroke-linejoin="round" class="lucide lucide-settings w-5 h-5">
                    <path
            ...
            <a href="#"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" class="lucide lucide-help-circle w-5 h-5">
    ...
    <!-- Bottom Card (always at the bottom) -->
    <div class="p-4 border-t border-gray-100 dark:border-slate-700">
        <div
            class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg p-4 text-white dark:from-orange-600 dark:to-orange-800">
            <div class="flex items-center space-x-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" class="lucide lucide-crown w-5 h-5 text-yellow-300">
