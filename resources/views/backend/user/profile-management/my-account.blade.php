            ...
            <div class="p-4 sm:p-6">
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6">
                    ...
                    <div class="lg:col-span-3 space-y-4 sm:space-y-6">
                        ...
                        <div id="tabContent">
                            <!-- Tracks Tab -->
                            <div class="tab-panel hidden" id="tracks">
                            ...
                            {{-- transaction --}}
                            <div id="transaction" class="tab-panel hidden mt-4">
                            ...
                            <div id="insights" class="tab-panel  mt-4">
                                <div
                                    class="bg-gray-100 dark:bg-slate-800 rounded-lg p-4 sm:p-6 border border-gray-200 dark:border-slate-700">
                                    <div
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400 text-xxs sm:text-xs mt-1">Above
                                                average
