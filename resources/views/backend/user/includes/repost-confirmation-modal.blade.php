<div x-data="{ showRepostConfirmationModal: @entangle('showRepostConfirmationModal').live }" wire:ignore.self>
    <div x-show="showRepostConfirmationModal" x-cloak x-transition:enter="transition ease-out duration-300"
