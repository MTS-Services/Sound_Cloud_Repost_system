        ...
        <div x-data="{
            ...
            <form wire:submit.prevent="createCampaign" class="space-y-6">
                ...
                <div class="mt-4">
                    ...
                    <!-- Slider -->
                    <div class="relative">
                        <input type="range" x-model="localCredit" x-on:input="$wire.set('credit', localCredit)"
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-700 dark:text-gray-400">Motivate real users to like your track (2
                            credits per like).</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <div x-show="showRepostPerDay" x-transition class="p-3">
                        <div class="flex justify-between items-center gap-4">
                            <input type="range" x-model="localMaxRepostsPerDay"
                                x-on:input="$wire.set('maxRepostsPerDay', localMaxRepostsPerDay)" min="0"
