                                ...
                                <div class="flex gap-6">
                                    <div class="text-center">
                                        <div class="flex items-center justify-center mb-2">
                                            ...
                                            <x-lucide-repeat class="text-gray-500 w-5 h-5 m-2 dark:text-white text-black" />
                                    ...
                                    <div class="text-center">
                                        <div class="flex items-center justify-center mb-2">
                                            <x-lucide-user-plus class="text-gray-500 w-5 h-5 m-2 dark:text-white text-black" />
                                    ...
                                    <div class="text-center">
                                        <div class="flex items-center justify-center mb-2">
                                            <x-lucide-heart class="text-gray-500 w-5 h-5 m-2 dark:text-white text-black" />
                                    ...
                                    <div class="text-center">
                                        <div class="flex items-center justify-center mb-2">
                                            <x-lucide-mail class="text-gray-500 w-5 h-5 m-2 dark:text-white text-black" />
                                    ...
                                    <div class="text-center">
                                        <div class="flex items-center justify-center mb-2">
                                            <x-lucide-smile class="text-gray-500 w-5 h-5 m-2 dark:text-white text-black" />
