...
<section class="py-16">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="#" class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 text-center">
...
<section class="bg-gray-100 dark:bg-gray-800 py-16">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-lg text-gray-600 dark:text-white mb-8 max-w-2xl mx-auto">
            Our support team is always here to help. Get in touch with us and we'll get back to you as soon as possible.
        </p>
        <a href="#" class="inline-block bg-blue-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg hover:bg-blue-700 transition-colors duration-300">
            Contact Support
        </a>
    </div>
</section>
