<x-user::layout>
    ...
    <div class="text-center py-12 px-4 sm:px-6 lg:px-8 h-screen w-full items-center dark:bg-gray-800">
        ...
        <p class="text-lg text-gray-300 mb-8">
            Our help and support section is currently being updated to provide you with better assistance. We’re working hard to bring you new resources and FAQs. Stay tuned!
        </p>
        <div class="flex justify-center items-center space-x-4">
            ...
            <span class="text-xl text-gray-400">We’ll be here to assist you shortly!</span>
        </div>
    </div>
</x-user::layout>
