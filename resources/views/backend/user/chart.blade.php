<x-user::layout>
    ...
    <div class="text-center py-12 px-4 sm:px-6 lg:px-8 h-screen w-full items-center dark:bg-gray-800">
        ...
        <p class="text-lg text-gray-300 mb-8">
            We're working on enhancing your settings page to give you more control and customization options. Please check back soon for more features!
        </p>
        <div class="flex justify-center items-center space-x-4">
            ...
            <span class="text-xl text-gray-400">We’re fine-tuning your settings experience!</span>
        </div>
    </div>
</x-user::layout>