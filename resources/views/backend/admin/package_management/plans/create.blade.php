                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            <x-inputs.input name="monthly_price" label="{{ __('Monthly Price') }}"
                                ...
                                :messages="$errors->get('monthly_price')" />
                        </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
                                @forelse ($features as $feature)
                                    <div x-data="{ checked: true }" x-init="checked = true">
                                        <input type="checkbox" name="features[]" checked value="{{ $feature->id }}"
                                            id="feature_{{ $feature->id }}" x-model="checked" class="hidden">
                                        <div :class="checked
                                            ?
                                            'border-blue-500 ring-2 ring-blue-200 dark:ring-blue-900/50 bg-blue-100 dark:bg-blue-900/30 h-full' :
                                            'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700'"
                                            class="flex flex-col items-center p-3 border rounded-lg transition-all duration-200 hover:border-blue-400 dark:hover:border-blue-500 hover:shadow-sm">
                                            ...
                                            <template x-if="checked">
                                                <div class="w-full mt-2">
                                                    <select name="feature_values[{{ $feature->id }}]"
                                                        ...
                                                        @click.stop>
                                                        <option value="" hidden selected>Select a
                                                            value</option>
