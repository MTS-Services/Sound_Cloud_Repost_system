                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                ...
                                <input type="text" placeholder="Name" name="name" value="{{ $credit->name }}"
                                    class="flex-1" />
                            </label>
                       ...
                       <!-- Price -->
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                <input type="number" name="price" value="{{ $credit->price }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                <input type="text" name="credits" value="{{ $credit->credits }}"
                    ...
                    <div class="space-y-2">
                       <p class="label py-2">{{ __('Notes') }}</p>
                        <textarea name="notes" id="notes" rows="4" placeholder="Enter notes"
                            class="w-full border-gray-300 dark:border-gray-600">{{ $credit->notes }}</textarea>
