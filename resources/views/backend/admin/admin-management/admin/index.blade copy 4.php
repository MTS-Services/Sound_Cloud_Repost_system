<x-admin::layout>
    ...
    <section>
        ...
        <div class="glass-card rounded-2xl p-6 mt-6">
            ...
            <table id="export-table" class="table-zebra">
                <thead>
                    <tr>
                        <th>
                ...
                <tbody>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                        <td>01</td>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">John Doe</td>
                        <td>zZCwI@example.com</td>
                        <td>2023-01-01</td>
                        <td>Auction buttons</td>
                    </tr>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                        <td>02</td>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">John Doe</td>
