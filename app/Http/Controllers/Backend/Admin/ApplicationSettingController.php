...
class ApplicationSettingController extends Controller implements HasMiddleware
{
    ...
    {
        $data['payment_settings'] = ApplicationSetting::whereIn('key', ['paypal_mode', 'paypal_key', 'paypal_secret', 'stripe_mode', 'stripe_key', 'stripe_secret', 'stripe_webhook_secret', 'paypal_gateway_status', 'stripe_gateway_status'])->pluck('value', 'key')->all();
